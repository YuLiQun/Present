package qunzai.present.refresh;
...
public class MeiTuanRefreshFirstStepView extends View{
	...
	private void init(Context context) {
		//这个就是那个椭圆形图片
		initialBitmap = Bitmap.createBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.box_01));
		...
		endBitmap = Bitmap.createBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.box_01));
	}
